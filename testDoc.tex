...
\begin{document}
    ...
    \section{Figures}
        ...
        \begin{figure}[H]
            \begin{centering}
                \includegraphics[width=0.5\textwidth]{images/rootLocus.pang}
    ...
    \section{Tables}
        ...
        %     \caption{Table of specified parameters and achieved values}
            \csvreader[
                ...
                \csvexpval\parameter & \tablenum[table-format=1.2e1]{\target} & \tablenum[table-format=1.2e1]{\theoVal} & \tablenum[table-format=1.2e1]{\simMixVal}}
        % \end{table}
