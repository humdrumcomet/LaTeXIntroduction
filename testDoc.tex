...
\setminted{linenos=flase, autogobble, fontsize=\small, breaklines=true, bgcolor=LightGray} % set global options for minted environments
...
\begin{document}
    ...
    \section{In-document References}
        ...
        With it, you can refer to equations like the Fourier transform from earlier (Equation \ref{eqt:fourTrans}), or a figure (Figure \ref{fig:test}), table (Table \ref{Table:Parameters}), or any of the many things with automatic counters.
        ...
        \subsection{Preamble Starting Point}
                ...
                \begin{minipage}{0.6\linewidth}%
                    \begin{minted}[linenos=false,fontsize=\normalsize]{tex}
                        ...
                        \UseTblrLibrary{booktabs, siunitx, amsmath, diagbox}
                    \end{minted}
                \end{minipage}
